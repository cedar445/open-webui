...
export const ifCliSuggest = writable(false)
export const ifShowSuggest = writable(true)
export const resSuggest = writable("")
export const suggest1 = writable("suggest1")
export const suggest2 = writable("suggest2")
export const suggest3 = writable("suggest3")
export const ifShowComplete = writable(false)